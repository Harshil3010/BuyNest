      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0">
        <div>
          ...
          <p className="font-medium text-sm text-gray-600 mb-6">
            Sign Up and get 10% of on your first product.
          </p>
          <form className="flex ">
            <input
              type="email"
              placeholder="Enter your email"
              className="p-3 w-full text-sm border-t border-l border-b border-gray-300 ronded-l-md focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all "
              required
            />
            <button
              type="submit"
        ...
        <div>
            ...
            <ul className="space-y-2 text-gray-600">
                ...
                <li>
                    <Link to='#' className="hover:text-gray-500 transition-colors">Womens's Top Wear</Link>
                </li><li>
        ...
        <div>
          ...
          <div className="flex items-center space-x-4 mb-6">
            ...
            </a> <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer " className="hover:text-gray-500">
