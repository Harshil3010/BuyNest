...
const FeaturedCollection = () => {
  return (
    <section className='py-16 px-4 lg:px-4'>
        <div className="container flex mx-auto flex-col-reverse lg:flex-row items-center bg-green-50 rounded-3xl">
            ...
            <div className="lg:w-1/2">
                <img src={featured} alt="Alt Featured Collection" className='w-full h-full object-cover lg:rounded-tr-3xl lg:rounded-br-3xl' />
            </div>
        </div>
    </section>
  );
